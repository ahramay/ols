...
import { editHomeJoin, getHomeJoin } from "../../../store/api/allCoursesPage";
          ...
          <Card className="shadow">
            <CardHeader>
              <div className="clearfix">
                <h2 className="mb-0 float-left">Edit All Courses Page</h2>
              </div>
            </CardHeader>
